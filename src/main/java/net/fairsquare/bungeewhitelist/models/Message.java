...
public enum Message {
    ...
    ADD_COMMAND("&8- &6/whitelist add &8<&6username&8> &8[&6option name&8] &8[&6option args&8] &eadds a user to the whitelist."),
    ...
    INVALID_OPTION("&cProvided option &4%1$s &cdoes not exist."),
    ...
    WHITELIST_ENTRIES("&eThere are currently &6%1$s &eusers whitelisted (&8* &e= has custom option):"),
    WHITELIST_ENTRY("&6%1$s"),
    WHITELIST_ENTRY_OPTION("&6%1$s&8*"),
